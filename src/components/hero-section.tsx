  ...
  return (
    <div className="relative bg-secondary text-secondary-foreground py-16 sm:py-24 lg:py-32 overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-foreground/75"></div> {/* Changed overlay to 75% opacity */}
      </div>
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <WhatsAppCtaButton
            ...
            variant="link"
            size="lg"
            className="shadow-lg transition-transform hover:scale-105 text-primary-foreground hover:text-primary-foreground/80"
          />
        </div>
      </div>
    </div>
