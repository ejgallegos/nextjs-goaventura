...
const mockSlides: HeroSlide[] = [
  {
    ...
    title: 'Villa Unión es el comienzo de tu viaje',
    subtitle: 'Recorré los paisajes del oeste riojano. Te ayudamos a elegir excursiones, traslados y dónde quedarte.',
