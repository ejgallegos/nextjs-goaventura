...
export const metadata: Metadata = {
  ...
  description: 'Conoce cómo GoAventura recopila, usa y protege tu información personal.',
};
    ...
    <div className="bg-background py-12 md:py-16">
      <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-foreground prose-headings:font-headline prose-headings:text-primary">
          <p>En GoAventura, accesible desde https://goaventura.com.ar, una de nuestras principales prioridades es la privacidad de nuestros visitantes. Este documento de Política de Privacidad contiene tipos de información que son recopilados y registrados por GoAventura y cómo los usamos.</p>
          ...
          <p>GoAventura no recopila conscientemente ninguna Información de Identificación Personal de niños menores de 13 años. Si crees que tu hijo proporcionó este tipo de información en nuestro sitio web, te instamos encarecidamente a que te pongas en contacto con nosotros de inmediato y haremos nuestros mejores esfuerzos para eliminar rápidamente dicha información de nuestros registros.</p>
          
          <p className="mt-8 font-semibold">Por favor, reemplaza este contenido de ejemplo con la política de privacidad real y legalmente compatible de GoAventura.</p>
        </div>
