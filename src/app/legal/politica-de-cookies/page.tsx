    ...
    <div className="bg-background py-12 md:py-16">
      <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-foreground prose-headings:font-headline prose-headings:text-foreground">
          <p>Esta es la Política de Cookies para Go aventura, accesible desde https://goaventura.com.ar</p>
          ...
          <p className="mt-8 font-semibold">Por favor, reemplaza este contenido de ejemplo con la política de cookies real y legalmente compatible de Go aventura.</p>
        </div>
