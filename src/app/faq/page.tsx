...
export const metadata: Metadata = {
  ...
  description: 'Resolvemos tus dudas sobre servicios, reservas y excursiones en Go Aventura.',
};
...
const faqData = [
  ...
  },
  {
    ...
    answer: 'Aceptamos tarjetas de crédito/débito, transferencias bancarias y Mercado Pago. Para pagos en efectivo o en moneda extranjera, por favor consúltanos.',
  },
  {
    question: '¿Cuál es la política de cancelación?',
    answer: 'Generalmente, ofrecemos un reembolso completo si cancelas con al menos 48 horas de antelación. Para paquetes y alojamientos, las condiciones pueden ser diferentes. Te recomendamos revisar las condiciones específicas al momento de reservar o consultarnos directamente.',
  },
  {
    question: '¿Necesito estar en buena forma física para las excursiones?',
    answer: 'Ofrecemos excursiones para todos los niveles de condición física. Algunas, como la de Laguna Brava, alcanzan altitudes considerables (4300 msnm) y no son recomendables para personas con problemas cardíacos. Cada descripción de excursión especifica el nivel de dificultad.',
  },
  {
