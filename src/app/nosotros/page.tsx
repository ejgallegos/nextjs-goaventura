...
export const metadata: Metadata = {
  title: 'Nosotros',
  description: 'Conoce más sobre Go aventua, nuestra misión, visión y el equipo que hace posibles tus aventuras.',
};
    ...
    <div className="bg-background py-12 md:py-16">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-12 md:mb-16">
          <h1 className="font-headline text-4xl sm:text-5xl font-bold text-primary">Sobre Go aventua</h1>
        ...
        <section className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 md:mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-xl">
            <Image
              ...
              alt="Equipo de Go aventua en una expedición"
              width={600}
              height={400}
        ...
        <section className="text-center bg-secondary p-8 md:p-12 rounded-lg shadow-md">
          ...
          <WhatsAppCtaButton
            predefinedText="Hola Go aventua, me gustaría saber más sobre sus servicios."
